package Atividade_Dia_a_Dia04.Aplicativo;
import Atividade_Dia_a_Dia04.Entidades.Estacionamento;
import Atividade_Dia_a_Dia04.Entidades.enums.status;
...
import java.util.Scanner;
    ...
    public class Main {
        ...
        public static void main(String[] args) {
            ...
            status status  = Atividade_Dia_a_Dia04.Entidades.enums.status.INFORMACOES_ADICIONADAS;
            ...
            if (placaSaida.equalsIgnoreCase(estacionamento.getPlaca())) {
                ...
                try {
                    if (pagamento.equalsIgnoreCase("não")) {
                        status= Atividade_Dia_a_Dia04.Entidades.enums.status.PAGAMENTO_NAO_AUTORIZADO;
                        System.out.println(status.getDescricao());

                    } else {
                        vagasDisponiveis++;
                        status= Atividade_Dia_a_Dia04.Entidades.enums.status.PAGAMENTO_REGISTRADO;
                        System.out.println(status.getDescricao());

                        status= Atividade_Dia_a_Dia04.Entidades.enums.status.SAIDA_LIBERADA;
                        System.out.println(status.getDescricao());
                    }
                } catch (Exception e){
                ...
                status= Atividade_Dia_a_Dia04.Entidades.enums.status.VEICULO_NAO_ENCONTRADO;
                System.out.println(status.getDescricao());
            }
        }
    }
